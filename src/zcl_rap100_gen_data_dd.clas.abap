CLASS zcl_rap100_gen_data_dd DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_DD IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'DD',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav_dd.
    DELETE FROM zrap100_dtrav_dd.

    "insert travel demo data
    INSERT zrap100_atrav_dd  FROM (
        SELECT
