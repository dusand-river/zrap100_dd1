...
@EndUserText.label: '##GENERATED Travel App (DD)'
@Search.searchable: true
@ObjectModel: {
  sapObjectNodeType.name: 'ZRAP100_ATRAV_DD'
}
@AccessControl.authorizationCheck: #MANDATORY
define root view entity ZRAP100_C_TRAVELTP_DD
  provider contract transactional_query
  as projection on ZRAP100_R_TRAVELTP_DD
  association [1..1] to ZRAP100_R_TRAVELTP_DD as _BaseEntity on $projection.TravelID = _BaseEntity.TravelID
{
